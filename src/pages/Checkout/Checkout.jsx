...
const Checkout = () => {
  ...
  const handleConfirmOrder = () => {
    ...
    if (cart.length > 1 || cart[0].quantity > 1) dispatch(emptyCart());
  ...
  return (
    <div className="checkout">
      ...
      <section className="checkoutCart">
        ...
        <button className="blueButton" onClick={handleConfirmOrder}>
          Confirm Order
        </button>
        <button className="blueButton" onClick={handleCancel}>
          Cancel
        </button>
      </section>
    </div>
